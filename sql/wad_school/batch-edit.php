...
<section class="bg-gray-100 p-16 rounded-lg">
    ...
    <h2 class="text-2xl font-bold mb-3">Edit Batch</h2>
    ...
    <form action="./batch-update.php?row_id=<?=$id ?>" method="post">
        <div class="flex flex-col items-center justify-between gap-5">
            <div class="w-full">
                ...
                <input value="<?=$batch['name'] ?>" type="text" name="name" id="name" required class="outline-none py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Special Web Design">
            </div>
            <div class="w-full">
                ...
                <select name="course_id" required id="hs-select-label" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                    ...
                    <?php while ($course = mysqli_fetch_assoc($query2)) : ?>
            ...
            <div class="w-full">
                ...
                <input value="<?=$batch['start_date'] ?>" type="date" name="start_date" id="start_date" required class="outline-none py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
            </div>
            <div class="w-full flex gap-5">
                <div class="w-full">
                    <label for="stock" class="block text-sm font-medium mb-2 dark:text-white">Start Time</label>
                    <input value="<?=$batch['start_time'] ?>" type="time" name="start_time" id="start_time" required class="outline-none py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                </div>
                <div class="w-full">
                    <label for="stock" class="block text-sm font-medium mb-2 dark:text-white">End Time</label>
                    <input value="<?=$batch['end_time'] ?>" type="time" name="end_time" id="end_time" required class="outline-none py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                </div>
            </div>
            ...
            <div class="w-full">
                <label for="hs-checkbox-on-right" class="flex p-3 w-full bg-white border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <input <?= $batch['is_register_open']==1? 'checked' : '' ?> type="checkbox" name="register" class="shrink-0 ms-auto mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checkbox-on-right">
                </label>
            </div>

            <div class="w-full">
                <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Student Limit</label>
                <input value="<?=$batch['student_limit'] ?>" type="number" name="student_limit" id="student_limit" required class="outline-none py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="15">
            </div>
