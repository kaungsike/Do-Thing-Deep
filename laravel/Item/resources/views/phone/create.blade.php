            ...
            <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-900">
                ...
                <form method="post" action="{{ route('phone.store') }}">
                    ...
                    <div
                        ...
                        <label for="phone_number" class="inline-block text-sm font-medium dark:text-white">
                            Phone Number
                        </label>
                        ...
                        <div class="mt-2 space-y-3">
                            <input id="phone_number" type="number" name="phone_number"
                                ...
                                placeholder="">
                                        ...
                                        <div class="mb-5">
                        <label for="people_id" class="block text-sm font-medium mb-2">Select a category</label>
