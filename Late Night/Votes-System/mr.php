...
<body class="bg-gray-100 text-gray-800">
    <div class="flex flex-col md:flex-row h-screen">
        <!-- Sidebar -->
        <aside class="bg-blue-700 text-white w-full md:w-1/4 h-20 md:h-full flex md:flex-col items-center md:items-start p-4">
            <div class="flex items-center justify-center md:justify-start space-x-2 mb-4 md:mb-8">
                <img src="https://via.placeholder.com/50" alt="Profile" class="rounded-full h-12 w-12">
                <div>
                    <h1 class="text-lg font-bold">Juan Dela Cruz</h1>
                    <a href="#" class="text-sm underline">View Profile</a>
                </div>
            </div>
